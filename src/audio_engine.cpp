...
static void ma_engine_callback(ma_device* pDevice, void* pOutput, const void* pInput, ma_uint32 frameCount) {
    (void)pInput;
...
void AudioEngine::add_node(std::shared_ptr<AudioNode> node) {
