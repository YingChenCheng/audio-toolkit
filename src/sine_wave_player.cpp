...
static void ma_audio_callback_bridge(ma_device *pDevice, void *pOutput, const void *pInput,
...
void SineWavePlayer::audio_callback(void *output_buffer, const void *input_buffer,
